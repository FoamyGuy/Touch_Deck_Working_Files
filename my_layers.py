    ...
    "layers":[
        {
            ...
            "shortcuts":[
                ...
                {
                    "label": "Code Format",
                    "icon": "touch_deck_icons/td_teal.bmp",
                    "actions": (KEY, [Keycode.CONTROL, Keycode.LEFT_ALT, Keycode.L])
                },
                {
                    "label": "Project",
                    "icon": "touch_deck_icons/td_gold.bmp",
                    "actions": (KEY, [Keycode.LEFT_ALT, Keycode.ONE])
                },
                {
                    "label": "Logcat",
                    "icon": "touch_deck_icons/as_logcat.bmp",
                    "actions": (KEY, [Keycode.LEFT_ALT, Keycode.SIX])
                },
                {
                    "label": "IDE Terminal",
                    "icon": "touch_deck_icons/ide_terminal.bmp",
                    "actions": (KEY, [Keycode.LEFT_ALT, Keycode.F12])
                },
                {
                    "label": "Git Add",
                    "icon": "touch_deck_icons/git_add.bmp",
                    "actions": (KEY, [Keycode.CONTROL, Keycode.LEFT_ALT, Keycode.A])
                },
            ]
        },
        {
